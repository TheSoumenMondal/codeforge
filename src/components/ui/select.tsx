...
function SelectGroup(
  props: ComponentPropsWithoutRef<typeof SelectPrimitive.Group> & {
    className?: string;
  },
) {
...
function SelectContent(
  props: ComponentPropsWithoutRef<typeof SelectPrimitive.Popup> & {
    className?: string;
    children?: ReactNode;
    side?: NonNullable<
      ComponentPropsWithoutRef<typeof SelectPrimitive.Positioner>["side"]
    >;
    align?: NonNullable<
      ComponentPropsWithoutRef<typeof SelectPrimitive.Positioner>["align"]
    >;
    alignOffset?: number;
    sideOffset?: number;
...
function SelectLabel(
  props: ComponentPropsWithoutRef<typeof SelectPrimitive.GroupLabel> & {
    className?: string;
  },
) {
  const { className = "", ...rest } = props;
...
function SelectScrollUpButton(
  props: ComponentPropsWithoutRef<typeof SelectPrimitive.ScrollUpArrow> & {
    className?: string;
  },
) {
  const { className = "", ...rest } = props;
...
function SelectScrollDownButton(
  props: ComponentPropsWithoutRef<typeof SelectPrimitive.ScrollDownArrow> & {
    className?: string;
  },
) {
  const { className = "", ...rest } = props;
