...
function ButtonGroup({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Button groups commonly use role="group" on a generic div
    <div
      role="group"
...
export interface IButtonGroupTextProps
  extends React.ComponentProps<"div">,
...
export interface IButtonGroupSeparatorProps
