...
type TDialogRootProps = ComponentPropsWithoutRef<
  typeof DialogPrimitive.Root
> & {
  modal?: boolean;
};

type TDialogBackdropProps = ComponentPropsWithoutRef<
  typeof DialogPrimitive.Backdrop
> & {
  className?: string;
};

type TDialogPopupProps = ComponentPropsWithoutRef<
...
function DialogViewport(
  props: ComponentPropsWithoutRef<typeof DialogPrimitive.Viewport>,
) {
  return (
                    ...
                    <DialogPrimitive.Close
                      ...
                      render={
                        <Button
                          variant="ghost"
                          size="icon"
                          className="rounded-full squircle-none size-8 p-0 -mr-4 -mt-2 absolute top-6 right-8"
                        >
                          <XCircleIcon
                            className="size-8! m-0"
                            weight="duotone"
                          />
